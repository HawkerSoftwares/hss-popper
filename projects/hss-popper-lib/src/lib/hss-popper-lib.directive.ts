...
import {Placement, Placements, PopperContentOptions, Trigger, Triggers} from '.';
...
export class HssPopperController implements OnInit, OnDestroy, OnChanges {
  private popperContentClass = HssPopperLibComponent;
  private popperContentRef!: ComponentRef<HssPopperLibComponent>;
  ...
  private popperContent!: HssPopperLibComponent;
  ...
  constructor(private viewContainerRef: ViewContainerRef,
    ...
    HssPopperController.baseOptions = {...HssPopperController.baseOptions, ...this.popperDefaults};
  }
  ...
  @Input('popper')
  content!: string | HssPopperLibComponent;
  ...
  @Output()
  popperOnShown: EventEmitter<HssPopperController> = new EventEmitter<HssPopperController>();

  @Output()
  popperOnHidden: EventEmitter<HssPopperController> = new EventEmitter<HssPopperController>();
  ...
  scheduledHide($event: any = null, delay: number = this.hideTimeout) {
    ...
    this.scheduledHideTimeout = setTimeout(() => {
      ...
      if (!popperContentView || popperContentView === toElement || popperContentView.contains(toElement) || (this.content as HssPopperLibComponent).isMouseOver) {
        return;
      }
      this.hide();
      this.applyChanges();
  ...
  private setDefaults() {
    this.showDelay = typeof this.showDelay === 'undefined' ? HssPopperController.baseOptions.showDelay : this.showDelay;
    this.showTrigger = typeof this.showTrigger === 'undefined' ? HssPopperController.baseOptions.trigger : this.showTrigger;
    this.hideOnClickOutside = typeof this.hideOnClickOutside === 'undefined' ? HssPopperController.baseOptions.hideOnClickOutside : this.hideOnClickOutside;
    this.hideOnScroll = typeof this.hideOnScroll === 'undefined' ? HssPopperController.baseOptions.hideOnScroll : this.hideOnScroll;
    this.hideOnMouseLeave = typeof this.hideOnMouseLeave === 'undefined' ? HssPopperController.baseOptions.hideOnMouseLeave : this.hideOnMouseLeave;
    this.ariaRole = typeof this.ariaRole === 'undefined' ? HssPopperController.baseOptions.ariaRole : this.ariaRole;
    this.ariaDescribe = typeof this.ariaDescribe === 'undefined' ? HssPopperController.baseOptions.ariaDescribe : this.ariaDescribe;
    this.styles = typeof this.styles === 'undefined' ? Object.assign({}, HssPopperController.baseOptions.styles) : this.styles;
  }
  ...
  private constructContent(): HssPopperLibComponent {
    ...
    return this.popperContentRef.instance as HssPopperLibComponent;
  }

  private setContentProperties(popperRef: HssPopperLibComponent) {
    popperRef.popperOptions = HssPopperController.assignDefined(popperRef.popperOptions, HssPopperController.baseOptions, {
  ...
  private onPopperUpdate(event: any) {
